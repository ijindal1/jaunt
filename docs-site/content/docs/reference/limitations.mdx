...
- Auto-generated PyPI skills (if enabled in your build): may do network calls to PyPI and additional OpenAI calls. Failures warn and continue, so behavior can differ based on environment and connectivity.

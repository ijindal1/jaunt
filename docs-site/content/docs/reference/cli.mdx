...
### Pre-Build: Auto-Generate PyPI Skills

Before generation, `jaunt build` can auto-generate “skills” for the external libraries your project imports and inject them into the build prompt (best-effort).

- Skills live under `<project_root>/.agents/skills/**/SKILL.md`.
- Failures warn and continue (build still runs, just without missing skills).

See: [Auto-Generated PyPI Skills (Build)](/docs/guides/pypi-skills).
